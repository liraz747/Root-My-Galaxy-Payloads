...
#define BUILD_VARIANT_LABEL "dm2q-S916BXXS8CYBD-tracefs-shaped-configfs-pipe-root"
...
/* Pinned to 0 ticks; device-validated on S916BXXS8CYBD via the app. */
...
#else
#define BUILD_VARIANT_LABEL "dm2q-S916BXXS8CYBD-root-umh"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/dm2q-S916BXXS8CYBD/p0_fingerprint.h"
#endif
...
#define KMALLOC_CACHES_OFF 0x01f1d980ULL
#define ANON_PIPE_BUF_OPS_OFF 0x01d49d60ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x028de470ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00103590ULL

#define ASHMEM_FOPS_OFF 0x01ec7100ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01c3e3c0ULL
